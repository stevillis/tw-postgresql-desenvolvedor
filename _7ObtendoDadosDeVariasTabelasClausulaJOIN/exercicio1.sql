...
Utilizando a tabela de alunos como tabela-base, complete a consulta abaixo para que 
todos os alunos e seus respectivos materiais sejam trazidos. Caso o aluno não possua material, 
ele deverá ser trazido como resultado da consulta da mesma maneira.
*/
...
LEFT JOIN geral.MAT_MATERIAIS mat ON aln.ALN_ID = mat.ALN_ID;
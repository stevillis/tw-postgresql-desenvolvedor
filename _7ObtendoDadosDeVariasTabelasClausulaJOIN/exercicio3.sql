...
Complete a consulta abaixo para que seja trazida a quantidade de materiais para cada aluno. Leve em consideração o comando que faça 
mais "sentido" para a situação. E.g.: se queremos a lista de alunos e a respectiva quantidade de materiais, fica implícito que a ligação 
entre alunos e materiais é mandatória. Alunos que não possuem material vinculado devem ser descartados para a realização da contagem.
*/
